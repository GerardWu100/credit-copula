...
def portfolio_loss_profile(credit_losses: np.ndarray, expected_loss: float, var_99: float) -> list[float]:
...
stats_summary = pd.DataFrame({
    'Metric': LOSS_METRICS,
    'Method A': portfolio_loss_profile(credit_losses_mvn, expected_loss_mvn, var_99_mvn),
    'Method B': portfolio_loss_profile(credit_losses_copula, expected_loss_copula, var_99_copula),
})
